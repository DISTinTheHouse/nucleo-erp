...
class Cotizacion(models.Model):
    ...
    empresa = models.ForeignKey(Empresa, on_delete=models.PROTECT, related_name="cotizacion", null=True, blank=True)
    ...
    sucursal = models.ForeignKey(Sucursal, on_delete=models.PROTECT, related_name="cotizacion", null=True, blank=True)
    ...
    persona_pagos = models.CharField(max_length=100, null=True, blank=True)
    correo_facturas = models.EmailField(max_length=150, null=True, blank=True)
    telefono_pagos = models.CharField(max_length=20, null=True, blank=True)
    oc = models.CharField(max_length=100, null=True, blank=True)
    forma_pago = models.CharField(max_length=5, choices=FormaPago.choices, null=True, blank=True)
    metodo_pago = models.CharField(max_length=10, choices=MetodoPago.choices, null=True, blank=True)
    uso_cfdi = models.CharField(max_length=10, choices=UsoCfdi.choices, null=True, blank=True)
    # Condiciones de pago
